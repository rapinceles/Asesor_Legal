...
# Función de inicialización (sin evento startup para evitar problemas)
def initialize_system():
    """Inicialización del sistema"""
    try:
        print("🔧 Ejecutando verificaciones de inicialización...")
        ...
        print("🎯 MERLIN inicializado correctamente")
        return True
...
async def health_check():
    """Health check endpoint para Render - versión simplificada"""
    try:
        # Test básico y rápido
